...
<div id="listForPat">
    <ul>
        <li class="itemPat"><a id="hideLink" href="Portal-Mockup-PAT.html.php" >Overview</a></li>
        ...
        <li class="itemPat" id="thatOne"><a id="hideLink" href="Portal-Mockup-upcomingMeeting.html.php" >Upcoming Meetings</a></li>
