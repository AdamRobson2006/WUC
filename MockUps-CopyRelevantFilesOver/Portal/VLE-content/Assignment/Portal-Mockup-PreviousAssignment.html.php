...
it makes that page darker/lighter AND when it  -->
    <ul>
        ...
        <li class="itemASS" id="thatOne"><a id="hideLink" href="Portal-Mockup-PreviousAssignment.html.php" >Previous Assignments</a></li>
        ...
        <li class="itemASS"><a id="hideLink" href="Portal-Mockup-Grades.html.php" >Grade</a></li>
    </ul>
</div>

<h2 >Your Previous Assignments!</h2>
